...
//        Class<?> clazz = Cartrofit.lookUp(Sub.class);
//        Cartrofit.addConverter(new Sub());
//    }
...
//
//
//        api = Cartrofit.obtainConverterScope("test")
//                .addConverter(new Converter<Integer, Boolean>() {
//                    @Override
//                    public Boolean convert(Integer value) {
//                        return value % 2 == 0;
...
//        CarData data = new CarData();
//        Cartrofit.inject(data);
////        CarData data = api.getComboData();
//        print("before extract data:" + data);
//
//        Cartrofit.apply(new CarData());
//
//        data = new CarData();
//        Cartrofit.inject(data);
//        print("after apply data:" + data);
...
//            }
//        });
//        Cartrofit.obtainConverterScope("test_scope").addConverter(new w)
//        CarData data = new CarData();
//        Cartrofit.inject(data);
////        CarData data = api.getComboData();
//        print("before extract data:" + data);
